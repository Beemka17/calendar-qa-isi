...
<body
    ...
    <div class="flex-1 flex items-center justify-center px-4 py-16">
        <div
            ...
            {{-- Icon --}}
            <div
                class="w-16 h-16 bg-orange-50 dark:bg-orange-950 rounded-full flex items-center justify-center mx-auto mb-6">
            ...
            {{-- Code --}}
            <p class="text-7xl font-light text-orange-500 tracking-tight leading-none mb-2">500</p>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 leading-relaxed mb-8">
                Server mengalami masalah. Tim teknis telah diberitahu.
            ...
            <div class="flex items-center justify-center gap-3 flex-wrap">
                ...
                <button onclick="location.reload()"
                    class="inline-flex items-center gap-2 border border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-400 text-sm font-medium px-4 py-2 rounded-lg hover:border-gray-300 transition-colors">
                    Coba Lagi
                </button>
            </div>
